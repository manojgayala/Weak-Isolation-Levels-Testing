import java.sql.*;
import java.util.*;
import java.io.*;                                       // libraries are imported
import java.util.concurrent.*;

/*
    This test case contains 2 threads and 4 operations in 1st thread and 5 operations in 2nd thread
    The first thread contains all Insert operations
    The second thread contains all SelectAll operations
*/

public class PRT2 {               // Insert vs SelectAll

    static int MAX_OPS_PER_THREAD = 5;
...
public static void main(String[] args) throws SQLException {
    ...
    {
        String db = args[0];                    // coding of database
    ...
    try{
        Iteration.fout = new FileWriter("../text/"+Iteration.name+"_PRT2_iterations.txt");
    }catch(IOException e){
    ...
    try{
        fout = new FileWriter("../text/"+Iteration.name+"_PRT2_summary.txt");
        int k=0;
        for(int i=0;i<NUM_THREADS;i++)
        {
