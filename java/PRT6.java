...
/*
    This test case contains 3 threads and 4 operations per each thread
    All three threads contain Insert, SelectAll, Update, SelectAll
    But the internally there is a cyclic operation happening, the first thread updates secon thread's inserted row,
    the second thread updates the third thread's inserted row and the third thread updates the first thread's inserted row
*/

public class PRT6 {                         // 3 threads; Update vs Update vs Update
...
public static void main(String[] args) throws SQLException {
    ...
    try{
        Iteration.fout = new FileWriter("../text/"+Iteration.name+"_PRT6_iterations.txt");
    }catch(IOException e){
    ...
    try{
        fout = new FileWriter("../text/"+Iteration.name+"_PRT6_summary.txt");
        int k=0;
        for(int i=0;i<NUM_THREADS;i++)
        {
